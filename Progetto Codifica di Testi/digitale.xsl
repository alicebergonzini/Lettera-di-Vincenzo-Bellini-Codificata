			...
			<body>
				...
				<div id="corpolettera">
					...
					<div id="#regole" class="infolettera">
						...
						<p style="margin-top: 20px; "><xsl:text>Passa il cursore sulle parole evidenziate per leggere nuove informazioni e clicca sulle forme compresse e desuete per scoprirne la correzione.</xsl:text> </p>
					</div>
